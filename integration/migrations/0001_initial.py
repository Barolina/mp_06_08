    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('biggest_city', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='integration.City', verbose_name='biggest city')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('continent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='countries', to='integration.Continent', verbose_name='continent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('basin_countries', models.ManyToManyField(blank=True, related_name='seas', to='integration.Country')),
                ('ocean', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='integration.Ocean', verbose_name='ocean')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='integration.Sea', verbose_name='parent')),
            ],
            options={
                'verbose_name': 'sea',
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='integration.Country', verbose_name='largest country'),
        ),
        migrations.AddField(
            model_name='continent',
            name='oceans',
        ...
        migrations.AddField(
            model_name='city',
            name='country',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cities', to='integration.Country', verbose_name='country'),
        ),
